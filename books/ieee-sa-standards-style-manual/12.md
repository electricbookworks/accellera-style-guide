...
The working group shall obtain permission where needed. The IEEE SA should be contacted at [stds-copyright@ieee.org](mailto:stds-copyright@ieee.org), in instances where legal agreements are required (see [Clause 5](05.md)).
...
For the creation and maintenance of IEEE Standards terms and definitions, see [Annex A](annex-a.md).
...
See [Annex A](annex-a.md) for Guidelines and best practices for the creation and maintenance of IEEE standards terms and definitions.
